...
def main():
    ...
    for t in targets:
        ...
        try:
            ...
            print(f"  Target 삭제 실패 (계속 진행): {e}", file=sys.stderr)
    ...
    try:
        ...
        print(f"Gateway 삭제 실패: {e}", file=sys.stderr)
        sys.exit(2)
